...
(function() {
  ...
  // Theme constants
  const THEME_KEY = 'automation-exercises-theme';
  ...
  // Get the saved theme or default to system preference
  ...
  function updateToggleButton(theme) {
    ...
    if (button) {
      button.innerHTML = theme === DARK_THEME ? sunIcon : moonIcon;
  ...
  function initTheme() {
    ...
    if (nav && !document.querySelector('.theme-toggle')) {
      ...
      if (navLinks) {
        nav.insertBefore(toggleButton, navLinks.nextSibling);
      } else {
